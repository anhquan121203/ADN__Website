...
const ModalRequestKit = ({ open, onClose, appointmentId, onSuccess }) => {
  ...
  const handleSubmit = async () => {
    try {
      ...
      setSubmitting(true);
      const res = await collectSample(appointmentId, values.type, values.person_info);
...
export default ModalRequestKit;
