  ...
  return (
    <div className="aboutUs-page">
      ...
      <nav className="aboutUs-page__btn-group" aria-label="Primary actions">
        <button
          className="aboutUs-page__btn aboutUs-page__btn--blue"
          type="button"
          aria-label="Button to register for consultation"
        >
          Đăng ký tư vấn
        </button>
        <button
          className="aboutUs-page__btn aboutUs-page__btn--orange"
          type="button"
          aria-label="Button to schedule an appointment"
        >
          Đặt lịch hẹn
        </button>
        <button
          className="aboutUs-page__btn aboutUs-page__btn--green"
          type="button"
          aria-label="Button for patient guide"
        >
          Trợ giúp bệnh nhân
        </button>
      </nav>
      ...
      <main className="aboutUs-page__container" role="main">
        <section
          className="aboutUs-page__intro-section"
          aria-labelledby="intro-title"
        >
          <article className="aboutUs-page__intro-text">
            <h2 id="intro-title">Giới thiệu chung</h2>
            <p>
              Blooding DNA Testing ý chính mục tiêu mang đến một môi trường y tế
              - chăm sóc sức khỏe chất lượng cao và đồng bộ, góp phần nâng cao
              sức khỏe cộng đồng, nâng tầm dịch vụ y tế.
            </p>
            <div
              className="aboutUs-page__vision-mission"
              aria-label="Vision and mission statements"
            >
              <strong>Tầm nhìn</strong>
              <span>
                Blooding DNA Testing cam kết phát triển hệ thống y tế hiện đại
                với đội ngũ y bác sĩ hàng đầu, đem lại dịch vụ y tế chất lượng
                cao cho cộng đồng thông qua công nghệ tiên tiến và trải nghiệm
                khác biệt.
              </span>
              <strong>Sứ mệnh</strong>
              <span>
                Chăm sóc sức khỏe toàn diện, tận tâm và hiệu quả với sự chuyên
                nghiệp và tận tụy.
              </span>
            </div>
          </article>
        ...
        {/* Giá trị cốt lõi */}
        <section
          className="aboutUs-page__values-section"
              ...
              <div className="aboutUs-page__values-grid">
                <div className="aboutUs-page__value-card">
                  ...
                  <div>
                    ...
                    <p>
                      Không ngừng sáng tạo và đổi mới nhằm mang lại các giải
                ...
                <div className="aboutUs-page__value-card">
                  ...
                  <div>
                    ...
                    <p>
                      Chịu trách nhiệm cao nhất với bệnh nhân và người nhà về y
                      đức, kỹ năng, tri thức và chuyên môn.
                    </p>
                  </div>
                </div>
                <div className="aboutUs-page__value-card">
                  ...
                  <div>
                    ...
                    <p>
                      Cam kết mang lại độ tin cậy cao nhất với dịch vụ y tế chất
                      lượng và an toàn.
                    </p>
                  </div>
                </div>
                <div className="aboutUs-page__value-card">
                  ...
                  <div>
                    ...
                    <p>
                      Hướng tới chất lượng dịch vụ cao nhất và quy trình khám
                      chữa bệnh tốt nhất.
                    </p>
                  </div>
                </div>
      ...
      <aside
        className="aboutUs-page__system-capacity"
        aria-labelledby="system-capacity-title"
        role="complementary"
      >
        <div className="aboutUs-page__container">
          ...
          <div className="aboutUs-page__capacity-grid" role="list">
            {[
              ...
              <div
                className="aboutUs-page__capacity-item"
                role="listitem"
                key={index}
              >
                <strong>{value}</strong>
