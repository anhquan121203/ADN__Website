    ...
    <div className="homepage">
      <header className="homepage__header">
        <div className="homepage__container">
          <div className="homepage__hero">
            <div className="homepage__hero-text" aria-label="Chăm sóc bằng tài năng, y đức và sự thấu cảm">
              <h1>
                Chăm sóc bằng tài năng, <br /> y đức và sự thấu cảm
              </h1>
              <a href="#" className="homepage__btn-primary" aria-label="Xem thêm">Xem thêm</a>
            </div>
            ...
            <div className="homepage__hero-image" aria-label="Ảnh người phụ nữ mang thai đang cười">
              <img
          ...
          <section className="homepage__info-boxes">
            <article className="homepage__info-box">
              <svg viewBox="0 0 24 24"><path d="M12 2C8.13 2 5 5.13 5 9c0 1.5.75 4.5 2.5 7 1.41 1.98 2.86 3 4.5 3s3.09-1.02 4.5-3c1.75-2.5 2.5-5.5 2.5-7 0-3.87-3.13-7-7-7z" /></svg>
              <strong>Gọi tổng đài</strong>
              Tư vấn và hỗ trợ 24/7 cho các vấn đề của bạn
            </article>
            <article className="homepage__info-box">
              <svg viewBox="0 0 24 24"><path d="M19 3h-3V1h-8v2H5a2 2 0 00-2 2v14a2 2 0 002 2h14a2 2 0 002-2V5a2 2 0 00-2-2zm0 16H5V8h14z" /></svg>
              <strong>Đặt lịch hẹn</strong>
              Đặt lịch hẹn nhanh chóng, tiện lợi và chính xác
            </article>
            <article className="homepage__info-box">
              <svg viewBox="0 0 24 24"><path d="M11 7h2v6h-2zm0 8h2v2h-2z" /></svg>
      ...
      <main className="homepage__main">
        ...
        <section className="homepage__certifications">
          <div className="homepage__container">
            <div className="homepage__cert-info">
              ...
              Vinmec tự hào được các tổ chức y tế hàng đầu thế giới công nhận
            </div>
        ...
        <section className="homepage__clinic">
          ...
          <p>Vinmec là hệ thống y tế tiên tiến nhất tại Việt Nam...</p>
          <div className="homepage__clinic-gallery">
            <div className="homepage__clinic-main">
              <img
                src="https://storage.googleapis.com/workspace-0f70711f-8b4e-4d94-86f1-2a93ccde5887/image/0d7ea7f2-905c-46e1-be9c-0e97f81cd90d.png"
                alt="Vinmec building"
              />
            </div>
          ...
          <a href="#" className="homepage__btn-secondary">Xem thêm</a>
        </section>
      </main>
